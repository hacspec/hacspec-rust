...
\inferrule[L-True]{\;}{\trans{\Gamma}{\rust{true}}{\mathsf{un}\;\mathsf{true}}}

\inferrule[L-False]{\;}{\trans{\Gamma}{\rust{false}}{\mathsf{un}\;\mathsf{false}}}

\inferrule[L-ConstArray]{
  \trans{\Gamma}{\rust{$l_1$}}{\mathsf{t}_1}\\
  \cdots\\
    \trans{\Gamma}{\rust{$l_n$}}{\mathsf{t}_n}
}{
  \trans{\Gamma}{\rust{[ $l_1$ ,..., $l_n$ ]}}{\mathsf{un}\;\mathsf{array}(\mathsf{t}_1,\ldots,\mathsf{t}_n)}
}

\\

\inferrule[E-Var]{{}}{\trans{\rust{$x$}\rightsquigarrow x,\;\Gamma}{\rust{$x$}}{x}}
...
\inferrule[E-FunctionCall]{
  \trans{\rust{$f$}\rightsquigarrow x, \Gamma}{\rust{$e_1$}}{\mathsf{t}_1}\\
  \cdots\\
  \trans{\rust{$f$}\rightsquigarrow x, \Gamma}{\rust{$e_n$}}{\mathsf{t}_n}\\
}{
  \trans{\rust{$f$}\rightsquigarrow x, \Gamma}{\rust{$f$ ( $e_1$ ,..., $e_n$ )}}{x\;\mathsf{t}_1\;\cdots\;\mathsf{t}_n}
}
